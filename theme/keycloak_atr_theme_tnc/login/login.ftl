...
<head>
    ...
    <link rel="shortcut icon" href="https://www.atrbpn.go.id/logo_app.png" type="image/x-icon" />
    <meta charset="utf-8">
...
<div class="login">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 px-0" style="overflow-y: auto; overflow-x: auto; height: 100vh;">
                        ...
                        <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                            ...
                            <div id="password-field">
                                ...
                                <div class="wrap-input password">
                                    ...
                                    <input  id="inputPassword" type="password" class="form-control" autocomplete="off" name="password" placeholder="Password">
                            ...
                            <div id="otp-field" class="wrap-input">
                                ...
                                <input type="text" class="form-control" autocomplete="off" maxlength="6" name="otp" placeholder="Kode Verifikasi">
                            </div>
